"""
Constants for CVSS4 computations and checks. Generated using util/generate_constants.py.
"""
...
METRICS_MANDATORY = ['AV', 'AC', 'AT', 'PR', 'UI', 'VC', 'VI', 'VA', 'SC', 'SI', 'SA']
...
METRICS_VALUE_NAMES = OrderedDict(
    [
        ...
        # Threat (1 metric)
        ('E', OrderedDict([('X', 'Not Defined'), ('A', 'Attacked'), ('P', 'POC'), ('U', 'Unreported')])),
        # Environmental (14 metrics)
        ...
        ('MAV', OrderedDict([('X', 'Not Defined'), ('N', 'Network'), ('A', 'Adjacent'), ('L', 'Local'), ('P', 'Physical')])),
        ...
        ('MUI', OrderedDict([('X', 'Not Defined'), ('N', 'None'), ('P', 'Passive'), ('A', 'Active')])),
        ...
        ('MSC', OrderedDict([('X', 'Not Defined'), ('H', 'High'), ('L', 'Low'), ('N', 'None')])),
        ('MSI', OrderedDict([('X', 'Not Defined'), ('S', 'Safety'), ('H', 'High'), ('L', 'Low'), ('N', 'None')])),
        ('MSA', OrderedDict([('X', 'Not Defined'), ('S', 'Safety'), ('H', 'High'), ('L', 'Low'), ('N', 'None')])),
        # Supplemental (6 metrics)
        ('S', OrderedDict([('X', 'Not Defined'), ('N', 'Negligible'), ('P', 'Present')])),
        ('AU', OrderedDict([('X', 'Not Defined'), ('N', 'No'), ('Y', 'Yes')])),
        ('R', OrderedDict([('X', 'Not Defined'), ('A', 'Automatic'), ('U', 'User'), ('I', 'Irrecoverable')])),
        ('V', OrderedDict([('X', 'Not Defined'), ('D', 'Diffuse'), ('C', 'Concentrated')])),
        ('RE', OrderedDict([('X', 'Not Defined'), ('L', 'Low'), ('M', 'Moderate'), ('H', 'High')])),
        ('U', OrderedDict([('X', 'Not Defined'), ('Clear', 'Clear'), ('Green', 'Green'), ('Amber', 'Amber'), ('Red', 'Red')])),
])
...
METRICS_ABBREVIATIONS_JSON = OrderedDict(
    [('AV', 'attackVector'),
     ...
     ('MAT', 'modifiedAttackRequirements'),
     ('MPR', 'modifiedPrivilegesRequired'),
     ('MUI', 'modifiedUserInteraction'),
     ('MVC', 'modifiedVulnConfidentialityImpact'),
     ('MVI', 'modifiedVulnIntegrityImpact'),
     ('MVA', 'modifiedVulnAvailabilityImpact'),
...
MACRO_VECTOR_NAMES = OrderedDict([
    (0, "Exploitability"),
    (1, "Complexity"),
    (2, "Vulnerable system"),
    (3, "Subsequent system"),
